...
$db_work_query = "SELECT * FROM works  WHERE ID=$id;";
$db_work_result = mysqli_query($db_connect, $db_work_query);
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="example-container">
                                ...
                                <input type="number" value="<?=$id ?>" name="work_id" hidden >
                                    
                                <div class="example-content">
                                        <label for="exampleInputEmail1" class="form-label">Work Title</label>
                                        <input type="text" value="<?= $work_query_convert_array["work_title"]?$work_query_convert_array["work_title"]: "" ?>" name="work_title" class="form-control"  aria-describedby="emailHelp">
                                    </div>
                                    <div class="example-content">
                                        <label for="exampleInputEmail1" class="form-label">Working Rol</label><span id="showIconService"></span>
                                        <input value="<?= $work_query_convert_array["work_rol"]?$work_query_convert_array["work_rol"]: "" ?>"  id="iconValueService" type="text" name="work_rol" class="form-control" aria-describedby="emailHelp">
                                    </div>
                                    <div class="example-content">
                                        ...
                                        <select class="form-select" name="work_status" aria-label="Default select example">
                                            ...
                                            <?= $work_query_convert_array["work_status"] === "active" ? "selected" : "" ?>
                                            
                                            value="active">Active</option>
                                            <option 
                                            <?= $work_query_convert_array["work_status"]=== "inactive"? "selected": ""?> 
                                            value="inactive">Inactive</option>
                                        </select>
                                    </div>
                                    <div class="example-content">
                                        <label for="exampleInputEmail1" class="form-label">Work Description</label>
                                        <textarea class="form-control" name="work_description"  id="floatingTextarea2" style="height: 100px">
                                        <?= $work_query_convert_array["work_description"]?$work_query_convert_array["work_description"]: "" ?>
                                        </textarea>
                                    </div>
                                    <div class="example-content">
                                    ...
                                    <button type="submit" name="update_work" class="btn btn-primary m-3">Add Work</button>
                                </form>
                            </div>
                        </div>
                    </div>
