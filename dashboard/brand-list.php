                                ...
                                <table class="table table-striped table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($db_brands_result as  $brand):
                                            ...
                                            <td>
                                                <div >
                                                    <a href="./update-brand.php?id=<?=$brand["ID"] ?>" class="btn btn-sm btn-primary">Edit</a>
                                                    <a href="./auth/delete/brand-delete.php?id=<?= $brand["ID"]?>" class="btn btn-sm btn-danger">Delete</a>
                                                </div>
                                            </td>
                                        </tr>
                                            <?php
